...
"<errors>"			{print("errors"    );return new Symbol(sym.INICIO_ERRORS ,yyline,yycolumn, (yytext())); }
"</errors>"			{print("FINAL_errors"     );return new Symbol(sym.FINAL_ERRORS  ,yyline,yycolumn, (yytext())); }
"<error>"			{print("error"    );return new Symbol(sym.INICIO_ERROR ,yyline,yycolumn, (yytext())); }
"</error>"			{print("FINAL_error"     );return new Symbol(sym.FINAL_ERROR  ,yyline,yycolumn, (yytext())); }
/*ATRIBUTOS DEL MAPA*/
